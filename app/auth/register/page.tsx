                ...
                <div className="w-full md:w-1/2 max-w-[420px]">
                    ...
                    <form className="space-y-5">
                        ...
                        <label className="flex items-center gap-3 cursor-pointer py-2">
                            <input type="checkbox" className="size-5 rounded-lg border-2 border-slate-200 accent-primary cursor-pointer" />
                            <span className="text-sm text-slate-500 font-medium">J'accepte les conditions d'utilisation</span>
                        </label>
                    ...
                    <div className="relative flex items-center justify-center my-8">
                        ...
                        <span className="absolute px-4 bg-white text-xs font-bold text-slate-300 uppercase">ou</span>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm font-bold text-slate-500">
                        Déjà membre ? <Link href="/auth/login" className="text-primary hover:underline">Se connecter</Link>
                    </p>
                </div>
            </div>
        </div>
