...
import { adminLoginAction } from '@/actions/auth/panel/login';
import { useAdminAuthValidationForm } from '@/hooks/use-validation-form';
...
export default function AdminSignIn() {
    ...
    const onSubmit = async (data: any) => {
        ...
        if (result?.error) {
            setError('Indentifiants invalides.');
            setIsPending(false);
        } else {
