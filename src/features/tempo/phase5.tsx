    ...
    return (
        ...
        <div className="course-container">
            ...
            <p className="course-paragraph">
                Jusqu’à présent, nous avons écrit du code ligne par ligne. Ce
                code fonctionne, mais il devient rapidement long, répétitif et
            ...
            <p className="course-paragraph">
                ...
                utilisée autant de fois que nécessaire, sans réécrire le même
                code.
            </p>
            ...
            <p className="course-paragraph">
                ...
                Elle permet d’éviter la répétition et rend le programme plus
                clair.
            </p>

            <p className="course-paragraph">
                Au lieu d’écrire le même code plusieurs fois, on écrit une
                fonction une seule fois, puis on l’appelle quand on en a besoin.
            </p>
            ...
            <p className="course-paragraph">
                Python fournit déjà plusieurs fonctions prêtes à l’emploi. Nous
                en avons déjà utilisé plusieurs sans forcément le savoir.
            </p>

            <p className="course-paragraph">
                Voici quelques fonctions prédéfinies que nous avons vues jusqu’à
                présent.
            </p>
            ...
            <h2 className="course-section-title">
                3. Créer sa propre fonction (fonction définie par l’utilisateur)
            </h2>

            <p className="course-paragraph">
                En programmation, une fonction est comme une{' '}
                <strong>petite machine</strong>. Cette machine reçoit un ordre,
                fait un travail précis, puis s’arrête. Le but d’une fonction est
                de <strong>regrouper des instructions</strong>
            ...
            <p className="course-paragraph">
                ...
                <strong>mot-clé</strong> : <code>def</code>. Ce mot indique à
                Python que ce qui suit est une fonction.
            </p>

            <p className="course-paragraph">
                Après <code>def</code>, on écrit le{' '}
                <strong>nom de la fonction</strong>. Ce nom est choisi par le
                programmeur et doit expliquer ce que la fonction fait. Ensuite,
                on met des parenthèses <code>()</code>, même si la fonction ne
            ...
            <p className="course-paragraph">
                ...
                l’intérieur, elle contient une seule instruction : afficher un
                message à l’écran. Tant que la fonction n’est pas appelée,{' '}
                <strong>rien ne s’exécute</strong>.
            </p>

            <p className="course-paragraph">
                Pour utiliser une fonction, on doit l’<strong>appeler</strong>.
                Appeler une fonction signifie dire à Python : « Exécute
                maintenant le code qui se trouve à l’intérieur de cette fonction
                ».
            </p>
            ...
            <p className="course-paragraph">
                ...
                C’est très pratique, car on écrit le code une seule fois et on
                l’utilise plusieurs fois sans duplication.
            </p>
            ...
            <p className="course-paragraph">
                Jusqu’ici, nous avons créé une fonction qui faisait toujours la
                même chose. Elle affichait toujours le même message. Mais dans
                la vraie vie, on a souvent besoin que la fonction
                <strong> s’adapte selon la situation</strong>.
            </p>

            <p className="course-paragraph">
                Pour cela, on utilise des <strong>paramètres</strong>. Un
                paramètre est une information que l’on donne à une fonction au
                moment où on l’appelle. On peut voir un paramètre comme une{' '}
                <strong>boîte vide </strong>
                que Python remplira plus tard.
            </p>

            <p className="course-paragraph">
                Lorsqu’on définit une fonction, on écrit les paramètres entre
                les parenthèses <code>()</code>. Ces paramètres n’ont pas encore
                de valeur à ce moment-là.
            </p>
            ...
            <p className="course-paragraph">
                ...
                <strong>à l’intérieur de la fonction</strong>. Elle attend de
                recevoir une valeur.
            </p>
            ...
            <p className="course-paragraph">
                ...
                fonction. Lors de l’appel, on donne une <strong>valeur</strong>{' '}
                au paramètre.
            </p>
            ...
            <p className="course-paragraph">
                Quand Python exécute cette ligne, il fait les étapes suivantes :
            </p>
            ...
            <p className="course-paragraph">
                ...
                <code>nom</code>, puis affiche <strong>Bonjour Jean</strong>. La
                fonction est la même, seule la valeur change.
            </p>
            ...
            <ul className="course-list">
                ...
                <li>
                    <strong>Valeur donnée</strong> : information envoyée lors de
                    l’appel (ex : <code>"Alice"</code>)
                </li>
                <li>
                    La fonction peut être réutilisée avec différentes valeurs
                </li>
            </ul>

            {/* ---------------------------- */}
            <h2 className="course-section-title">5. Plusieurs paramètres</h2>
            ...
            <div className="highlight-command">presentation("Paul", 20)</div>

            <h2 className="course-section-title">6. La fonction return</h2>

            <p className="course-paragraph">
                La plupart des débutants confondent <code>print()</code> et{' '}
                <code>return</code>. C’est une erreur normale, mais il est très
            ...
            <p className="course-paragraph">
                ...
                chose à l’écran.
                <strong>return</strong> sert à renvoyer une valeur à l’extérieur
                de la fonction.
            </p>

            <p className="course-paragraph">
                Une fonction avec <code>return</code> produit un résultat que
                l’on peut stocker dans une variable et réutiliser plus tard.
            </p>
            ...
            <p className="course-paragraph">
                Imagine une calculatrice. Tu lui donnes deux nombres, elle fait
                le calcul, puis elle te donne un résultat.
            </p>
            ...
            <p className="course-paragraph">
                ...
                résultat reste bloqué à l’intérieur de la fonction et tu ne peux
                pas l’utiliser ailleurs dans ton programme.
            </p>
            ...
            <p className="course-paragraph">
                ...
                utilisée dans la condition <code>if</code>. C’est pour cela que{' '}
                <code>return</code> est indispensable.
            </p>
            ...
            <p className="course-paragraph">
                Les fonctions sont le cœur de la programmation. Elles permettent
                d’organiser le code, d’éviter les répétitions et de construire
