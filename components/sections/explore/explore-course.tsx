...
export default function Courses() {
    ...
    const data = [
        ...
        },
        {
            ...
            icon: (
                <div className="size-12 rounded-xl bg-orange-50 text-orange-600 flex items-center justify-center font-bold text-2xl">
                    UI
                </div>
            ),
            tag: 'Frontend Design',
        ...
        <section className="pb-24 pt-16 bg-gradient-to-t from-white to-[#f8f9fa]">
            <div className="wrapper space-y-16">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    <Link
                        href="/explore"
                        className="group flex items-center gap-2 text-foreground font-black hover:text-primary transition-all pb-2 border-b-2 border-transparent hover:border-primary"
                    >
                        ...
                        >
                            <div className="bg-bg-muted rounded-[1.8rem] p-8 flex-1 flex flex-col">
                                ...
                                <div className="space-y-4 flex-1">
                                    <span className="px-3 py-1 bg-white rounded-lg text-[10px] font-black uppercase tracking-widest text-slate-500 border border-card-border">
                                        {course.tag}
                                    </span>
